...
def retrieve(
    ...
    *,
    ...
    requested_audience = str((filters or {}).get("audience", (principal_ctx or {}).get("audience", "")).strip().lower())

    for c in chunks:
        if requested_audience and str(c.get("audience", "internal")).lower() != requested_audience:
