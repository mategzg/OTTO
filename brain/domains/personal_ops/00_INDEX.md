...
Este dominio guarda aprendizaje operativo de OTTO derivado de ejecución real.
No describe "quién es Mateo" (eso vive en `memory/profile/*`); describe "cómo operar mejor".

## Mapa
- `brain/domains/personal_ops/10_DECISION_HEURISTICS.md`
